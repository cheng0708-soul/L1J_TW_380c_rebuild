...
public class Opcodes {
	...
	public static final int S_OPCODE_SKILLBUY_2 = 13; // 學習魔法 (何侖)
	...
	public static final int S_OPCODE_TELEPORT = 149; // 傳送術或瞬間移動卷軸-傳送鎖定 TODO
	...
	public static final int C_OPCODE_TELEPORTLOCK = 246; // 玩家傳送鎖定(回溯檢測用)
	public static final int C_OPCODE_SKILLBUYOK = 39; // 請求學習魔法
	public static final int C_OPCODE_DELEXCLUDE = 33; // 請求使用開啟名單(拒絕指定人物訊息)
	public static final int C_OPCODE_USEPETITEM = 104; // 請求使用寵物裝備
	...
	public static final int S_OPCODE_NEW2 = 72; // 不明封包 (會將頭銜變更為空白)
	...
	public static final int C_OPCODE_SELECTWARTIME = 1463;// 要求選擇
															// 變更攻城時間(but3.3C無使用)
