...
public class AnnouncementsCycle {
	...
	/** 在公告首顯示公告修改時間 */
	private boolean AnnounceTimeDisplay = false; // Config.Announcements_Cycle_Modify_Time;
	...
	private void cycle() {
		...
		GeneralThreadPool.getInstance().scheduleAtFixedRate(task, 100000, 60000 * 10); // Config.Announcements_Cycle_Time); // 10分鐘公告一次
	}
